...
export default function PropertyDetail() {
  ...
  // SEO Meta Tags
  const seoTitle = property.metaTitle || `${property.title} - Ernani Nunes Corretor`;
  const seoDescription = property.metaDescription || property.description?.substring(0, 160) || `${property.propertyType} para ${property.transactionType} em ${property.neighborhood}, ${property.city}. ${price}.`;
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                {property.salePrice && (
                  <FinanceSimulatorForm 
                    initialPropertyValue={property.salePrice} 
                    isWidget={true} 
                  />
                )}
